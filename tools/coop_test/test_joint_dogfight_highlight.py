...
Run:  python tools/coop_test/test_joint_dogfight_highlight.py
"""
...
def main():
    js = joint_fixture.bring_up("jdfhl", (48810, 48811, 48110))
    ...
    try:
        ...
        print("ALL JOINT DOGFIGHT-HIGHLIGHT TESTS PASSED")
    finally:
        js.shutdown()
