"""Playtest B3: soldier renames must synchronize in a SHARED campaign.
...
through a soldier_rename shared_cmd (host applies + broadcasts), exactly like the
...
Run:  python tools/coop_test/test_shared_soldier_rename.py
"""
...
def main():
    js = shared_fixture.bring_up("jsrename", (48780, 48781, 48080))
    ...
    try:
        ...
        print("ALL SHARED SOLDIER-RENAME TESTS PASSED")
    finally:
        js.shutdown()
