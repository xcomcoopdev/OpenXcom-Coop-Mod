...
Run:  python tools/coop_test/test_joint_dogfight_button_desync.py
"""
...
def main():
    js = joint_fixture.bring_up("jdfbtn", (48796, 48797, 48096))
    ...
    try:
        ...
        js.finish()
        print("ALL JOINT DOGFIGHT BUTTON-DESYNC TESTS PASSED")
    finally:
        js.shutdown()
