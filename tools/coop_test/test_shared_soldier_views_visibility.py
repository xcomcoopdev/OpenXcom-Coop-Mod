...
`&& SharedEcon::ownsSoldier(...)` filter validated by the same pattern.)

Run:  python tools/coop_test/test_shared_soldier_views_visibility.py
"""
...
def main():
    js = shared_fixture.bring_up("jviews", (48880, 48881, 48180))
    ...
    try:
        ...
        print("ALL SHARED SOLDIER-VIEW VISIBILITY TESTS PASSED")
    finally:
        js.shutdown()
