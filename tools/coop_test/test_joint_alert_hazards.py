"""Two JOINT divergence hazards surfaced by the alert audit.
...
HAZARD 1 - alien-base discovery was rolled TWICE.
  ...
  `alien_base_found` joint_cmd and replicas apply that.
...
Run:  python tools/coop_test/test_joint_alert_hazards.py
"""
...
def main():
    js = joint_fixture.bring_up("jhaz", (48912, 48913, 48212))
    ...
    try:
        ...
        js.finish()
        print("ALL JOINT ALERT-HAZARD TESTS PASSED")
    finally:
        js.shutdown()
