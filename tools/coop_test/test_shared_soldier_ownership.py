"""Playtest B4: SHARED starting soldiers must be split between the two seats.

A SHARED campaign is one shared roster. Every soldier carries an explicit owner
...
covered by test_shared_purchase.)

Run:  python tools/coop_test/test_shared_soldier_ownership.py
"""
...
def main():
    js = shared_fixture.bring_up("jsown", (48790, 48791, 48090))
    ...
    try:
        ...
        print("ALL SHARED SOLDIER-OWNERSHIP TESTS PASSED")
    finally:
        js.shutdown()
