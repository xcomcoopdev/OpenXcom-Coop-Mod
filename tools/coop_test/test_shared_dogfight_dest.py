...
Run:  python tools/coop_test/test_shared_dogfight_dest.py
"""
...
def main():
    js = shared_fixture.bring_up("jdfd", (48804, 48805, 48104))
    ...
    try:
        ...
        js.finish()
        print("ALL SHARED DOGFIGHT DEST (GAP-8) TESTS PASSED")
    finally:
        js.shutdown()
