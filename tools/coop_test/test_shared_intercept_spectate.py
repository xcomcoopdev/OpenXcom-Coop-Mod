...
Sequence:
  ...
  * the CLIENT commands the craft to intercept the UFO (craft_retarget shared_cmd);
...
Run:  python tools/coop_test/test_shared_intercept_spectate.py
"""
...
def main():
    js = shared_fixture.bring_up("jint", (48774, 48775, 48074))
    ...
    try:
        ...
        # CLIENT commands the craft to intercept the UFO (craft_retarget shared_cmd).
        ...
        js.finish()
        print("ALL SHARED INTERCEPT SPECTATE TESTS PASSED")
    finally:
        js.shutdown()
