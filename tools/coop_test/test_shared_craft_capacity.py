"""Feature (SHARED craft capacity): the shared craft is ONE physical ship with a single
...
Run:  python tools/coop_test/test_shared_craft_capacity.py
"""
...
def main():
    js = shared_fixture.bring_up("jcap", (48820, 48821, 48120))
    ...
    try:
        ...
        js.finish()
        print("ALL SHARED CRAFT-CAPACITY TESTS PASSED")
    finally:
        js.shutdown()
