...
Run:  python tools/coop_test/test_shared_dogfight_concurrent.py
"""
...
def main():
    js = shared_fixture.bring_up("jdfcc", (48814, 48815, 48114))
    ...
    try:
        ...
        print("ALL SHARED DOGFIGHT CONCURRENT + HK-RESHUFFLE TESTS PASSED")
    finally:
        js.shutdown()
