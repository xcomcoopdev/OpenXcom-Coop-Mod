"""SHARED base-attack replication: the base under attack is the ONE shared base, but only
...
Run:  python tools/coop_test/test_shared_base_attack.py
"""
...
def main():
    js = shared_fixture.bring_up("jbatk", (48944, 48945, 48244))
    ...
    try:
        ...
        shared_fixture.assert_world_equal(host, client, "after partial base destruction")
        ...
        print("ALL SHARED BASE-ATTACK TESTS PASSED")
    finally:
        js.shutdown()
