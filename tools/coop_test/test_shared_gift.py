"""Playtest (P4): gifting a soldier in SHARED transfers ownership and moves it
between the players' soldier lists.

Decision: keep the give-unit feature in SHARED. Gifting a soldier changes its owner;
...
Run:  python tools/coop_test/test_shared_gift.py
"""
...
def main():
    js = shared_fixture.bring_up("jgift", (48890, 48891, 48190))
    ...
    try:
        ...
        print("ALL SHARED GIFT TESTS PASSED")
    finally:
        js.shutdown()
