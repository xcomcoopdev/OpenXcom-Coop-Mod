...
enum UnitStatus : int {STATUS_STANDING = 1, STATUS_WALKING = 2, STATUS_FLYING = 3, STATUS_TURNING = 4, STATUS_AIMING = 5, STATUS_COLLAPSING = 6, STATUS_DEAD = 7, STATUS_UNCONSCIOUS = 8, STATUS_PANICKING = 9, STATUS_BERSERK = 10, STATUS_IGNORE_ME = 11};
