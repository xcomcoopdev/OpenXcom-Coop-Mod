...
void BuildFacilitiesState::init()
{
	...
	// the base screen this popup covers refreshes live (no-op unless SHARED campaign).
	_sharedRefresh.bind(_game, this, _base, true /*wantProgress*/);
}

/**
 * PRD-J10 / playtest B1: a peer's shared_apply changed this base's funds/facilities
